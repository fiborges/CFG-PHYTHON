...
# Função para criar o arquivo CSV de personagens
def create_character_csv():
    ...
    with open(csv_file, mode='w', newline='') as file:
        ...
        for character in characters:
            ...
            power = character_ranking.get(name, '')

            if house:
                writer.writerow([name, species, house, power])

    print(f'Character data saved in {csv_file}')

# Função para coletar dados de feitiços
def collect_spell_data():
    url = 'https://hp-api.onrender.com/api/spells'
    response = requests.get(url)
    spells = json.loads(response.text)
    return spells

# Função para criar o arquivo CSV de feitiços
def create_spell_csv():
    spells = collect_spell_data()
    ...
    with open(csv_file, mode='w', newline='') as file:
        ...
        for spell in spells:
            ...
            rank = spell_ranking.get(name, '')
            writer.writerow([name, description, rank])

    print(f'Spells data saved in {csv_file}')
...
print(f'Charaters data save in {csv_file}')
...
print(f'Spells data save in {csv_file}')
